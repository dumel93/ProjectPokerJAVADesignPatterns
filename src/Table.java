...
public class Table
{
	...
	private CommonCards communityCards;
	...
	public Table(){
		...
		this.communityCards = new CommonCards();
	}
	...
	public CommonCards getCommunityCards(){
	...
	public String toString(){
		String out = "Stół: " + this.tableNum;
		if( this.dealer != null )
			out += "\nDealer: " + this.dealer.getName();
		else
			out += "\nDealer: brak dealera";
		out += "\nLiczba graczy: " + this.players.size() + "/" + this.maxNumPlayer;
		out += "\nPula:  " + this.pot;
